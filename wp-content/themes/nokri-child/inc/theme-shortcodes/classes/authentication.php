...
class authentication
{
		...
		return '<form id="sb-login-form-data"  >
				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="form-group">
					   <input placeholder="'. esc_html($user_password_plc) .'" class="form-control" type="password" data-parsley-required="true" data-parsley-error-message="'. esc_html__( 'Password must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters.', 'nokri' ) .'" name="sb_reg_password" autocomplete="off" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}">
					</div>
				 </div>
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="form-group">
